...
<html lang="en">
      ...
      <section id="detect" class="section">
        ...
        <div class="panel">
          ...
          <details class="settings-bar">
            <summary class="settings-summary">Settings <span>Fruit naming control</span></summary>
  ...
  "annotated_image": "base64-jpeg"
    ...
    <script>
      ...
      function appendThresholdSettings(data){data.append("fruit_naming_enabled",fruitNamingEnabled.checked?"true":"false");}
